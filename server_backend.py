...
for dset_index, name in enumerate(dataset_manager.get_dataset_names()):
    ...
    # Create thumbnails:
    for subset_index, subset in enumerate(dset):
        thumbnailer.create_thumbnail(dset_index, subset_index, dset[subset]);
...
class Thumbnail(Resource):
    def get(self, dataset_id, subset_id):
        return send_file(thumbnailer.get_thumbnail_path(dataset_id, subset_id))
...
api.add_resource(Thumbnail,   API_BASE_STR + "/datasets/<dataset_id>/subsets/<subset_id>/thumbnail")
